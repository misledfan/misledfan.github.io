...
var handleSplashScreen = function handleSplashScreen() {
  ...
  function play_video() {
    var played = false;
    var player = new Vimeo.Player('logo-one', {
      id: 389215275,
      width: 320,
      muted: true,
      loop: false,
    ...
    player.on('play', function () {
      ...
      var player2 = new Vimeo.Player('logo-two', {
        id: 389216014,
        width: 320,
        muted: true,
        loop: false,
      ...
      player2.on('play', function () {
        ...
        $('.logo_part_one iframe , .logo_part_two iframe, .header__logo__new').addClass('onload');
        $('.header__logo__new a').removeClass('no_video_play');
        setTimeout(function () {
          if ($('.header').hasClass('animation_on')) {
            $('.logo-video').addClass('afterload');
            $('.logo_part_one iframe, .logo_part_two iframe').addClass('afterload');
...
var CaptchaCallback = function CaptchaCallback() {
  $('.g-recaptcha').each(function (index, el) {
    ...
    grecaptcha.render(el, {
      sitekey: '6LftUmMUAAAAAFrDB6qVtqc-J61v7JweJ4Izsfzb',
      hl: lang
    });
  });
};
